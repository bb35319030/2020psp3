...
## ソースコードの説明
75-79:動的計画法で利用する作成テーブルを初期化する（すべて０にする）
80:メニュー数だけ繰り返す
81-83:メニューの値段が持っているお金より大きい場合、テーブルの上の状態を引き継ぐ
84:メニューの値段が持っているお金より小さい場合、持っているお金が1000円になるまで繰り返す
85-91:メニューを入れ替えない場合のカロリーとメニューを入れ替えた場合のカロリーを比較して、大きいほうをテーブルに入れる
92:最大取得可能カロリーを出力する
